...
<header>
				...
				<div class="modal-body modal-body-sub_agile">
					...
					<div class="modal_body_left modal_body_left1">
						...
						<form action="/regist" method="post">
							<div id="formDiv">
								<div class="styled-input agile-styled-input-top">
									<input type="text" id="uname" placeholder="Name" name="uname" required="">
								</div>
								<input type="button" value="验证用户名" onclick="checkuname()">
								<div class="styled-input">
									<input type="email" id="email" placeholder="E-mail" name="email" required="">
								</div>
								<input type="button" value="验证邮箱" onclick="sendmail()">
								<div class="styled-input">
									<input type="text" id="code" placeholder="输入验证码" required="">
									<input type="hidden" id="resultCode">
									<input type="button" value="确认验证码" onclick="checkCode()">
								</div>
								<div class="styled-input">
									...
									<ul class="dropdown-menu multi-column columns-3">
										<div class="agile_inner_drop_nav_info">
											<div class="col-sm-6 multi-gd-img">
												<ul class="multi-column-dropdown">
													<li>
														<a href="product.jsp">Kitchen & Dining</a>
													</li>
													<li>
														<a href="product.jsp">Detergents</a>
													</li>
													<li>
														<a href="product.jsp">Utensil Cleaners</a>
													</li>
													<li>
														<a href="product.jsp">Floor & Other Cleaners</a>
													</li>
													<li>
														<a href="product.jsp">Disposables, Garbage Bag</a>
													</li>
													<li>
														<a href="product.jsp">Repellents & Fresheners</a>
													</li>
													<li>
														<a href="product.jsp"> Dishwash</a>
													</li>
												</ul>
											</div>
											<div class="col-sm-6 multi-gd-img">
												<ul class="multi-column-dropdown">
													<li>
														<a href="product.jsp">Pet Care</a>
													</li>
													<li>
														<a href="product.jsp">Cleaning Accessories</a>
													</li>
													<li>
														<a href="product.jsp">Pooja Needs</a>
													</li>
													<li>
														<a href="product.jsp">Crackers</a>
													</li>
													<li>
														<a href="product.jsp">Festive Decoratives</a>
													</li>
													<li>
														<a href="product.jsp">Plasticware</a>
													</li>
													<li>
														<a href="product.jsp">Home Care</a>
													</li>
												</ul>
											</div>
											<div class="clearfix"></div>
	...
	<script>
        ...
        function sendmail() {
            ...
            var email = $("#email").val();
            $.ajax({
                url: '/sendMail?uname='+uname+'&mailAddr='+email,
                type: 'GET',
                success: function (res) {
                    alert("验证邮件已发送");
                    $("#resultCode").val(res);
        ...
        function checkCode() {
			...
			if (resultCode==code){
			    alert("验证通过");
				$("#formDiv").append('<input type="submit" value="Sign Up">');
			}else {
			    alert("验证未通过");
			}
        }
