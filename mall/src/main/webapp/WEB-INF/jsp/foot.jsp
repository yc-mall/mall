				...
				<div class="col-sm-5 address-right">
					<div class="col-xs-6 footer-grids">
						...
						<ul>
							...
							<li>
								<a href="product.jsp">Dishwashers</a>
							</li>
							<li>
								<a href="product.jsp">Biscuits & Cookies</a>
							</li>
							<li>
								<a href="product.jsp">Baby Diapers</a>
							</li>
						</ul>
					</div>
					<div class="col-xs-6 footer-grids agile-secomk">
						<ul>
							...
							<li>
								<a href="product.jsp">Personal Care</a>
							</li>
							<li>
			...
			<div class="agile-sometext">
				...
				<div class="sub-some">
					...
					<ul>
						...
						<li>
							<a href="product.jsp">Head & Shoulders</a>
						</li>
						<li>
							<a href="product.jsp">Dove</a>
						</li>
						<li>
							<a href="product.jsp">Dettol</a>
						</li>
						<li>
							<a href="product.jsp">Dabur</a>
						</li>
						<li>
							<a href="product.jsp">Colgate</a>
						</li>
						<li>
							<a href="product.jsp">Coca-Cola</a>
						</li>
						<li>
							<a href="product.jsp">Closeup</a>
						</li>
						<li>
							<a href="product.jsp"> Cinthol</a>
						</li>
						<li>
						...
						<li>
							<a href="product.jsp">Fair & Lovely</a>
						</li>
						<li>
							<a href="product.jsp">Lakme</a>
						</li>
						<li>
							<a href="product.jsp">Tata</a>
						</li>
						<li>
							<a href="product.jsp">Sunfeast</a>
						</li>
						<li>
							<a href="product.jsp">Sunsilk</a>
						</li>
						<li>
